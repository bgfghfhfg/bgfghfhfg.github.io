function createUnityInstance(e, n, r) {
    function t(e, n, r) {
        if (u.startupErrorHandler)
            return void u.startupErrorHandler(e, n, r);
        if (!(u.errorHandler && u.errorHandler(e, n, r) || (console.log("Invoking error handler due to\n" + e),
    ...
    function o(e) {
        ...
        r && u.stackTraceRegExp && u.stackTraceRegExp.test(r)) {
            var o = e instanceof ErrorEvent ? e.filename : n && "string" == typeof n.fileName ? n.fileName : n && "string" == typeof n.sourceURL ? n.sourceURL : ""
              , s = e instanceof ErrorEvent ? e.lineno : n && "number" == typeof n.lineNumber ? n.lineNumber : n && "number" == typeof n.line ? n.line : 0;
            t(r, o, s)
        }
    }
    function s(e, n) {
    ...
    function i(e) {
        return new Promise(function(n, r) {
            ...
            t.addEventListener("progress", function(n) {
                s(e, n)
            }),
            t.addEventListener("load", function(r) {
                s(e, r),
                n(new Uint8Array(t.response))
            }),
            t.send()
        }
        )
        ...
        u.preRun.push(function() {
            ...
            e.then(function(e) {
                var n = new DataView(e.buffer,e.byteOffset,e.byteLength)
                  , r = 0
                  , t = "UnityWebData1.0\0";
                if (!String.fromCharCode.apply(null, e.subarray(r, r + t.length)) == t)
                ...
                for (r += 4; r < o; ) {
                    ...
                    u.FS_createDataFile(d, null, e.subarray(s, s + i), !0, !0, !0)
                }
    ...
    u.disabledCanvasEvents.forEach(function(n) {
    ...
    return u.SystemInfo = function() {
        var e, n, r, t = "-", o = navigator.appVersion, s = navigator.userAgent, i = navigator.appName, a = navigator.appVersion, d = parseInt(navigator.appVersion, 10);
        (n = s.indexOf("Opera")) != -1 ? (i = "Opera",
        a = s.substring(n + 6),
        (n = s.indexOf("Version")) != -1 && (a = s.substring(n + 8))) : (n = s.indexOf("MSIE")) != -1 ? (i = "Microsoft Internet Explorer",
        a = s.substring(n + 5)) : (n = s.indexOf("Edge")) != -1 ? (i = "Edge",
        a = s.substring(n + 5)) : (n = s.indexOf("Chrome")) != -1 ? (i = "Chrome",
        a = s.substring(n + 7)) : (n = s.indexOf("Safari")) != -1 ? (i = "Safari",
        a = s.substring(n + 7),
        (n = s.indexOf("Version")) != -1 && (a = s.substring(n + 8))) : (n = s.indexOf("Firefox")) != -1 ? (i = "Firefox",
        a = s.substring(n + 8)) : s.indexOf("Trident/") != -1 ? (i = "Microsoft Internet Explorer",
        a = s.substring(s.indexOf("rv:") + 3)) : (e = s.lastIndexOf(" ") + 1) < (n = s.lastIndexOf("/")) && (i = s.substring(e, n),
        a = s.substring(n + 1),
        i.toLowerCase() == i.toUpperCase() && (i = navigator.appName)),
        (r = a.indexOf(";")) != -1 && (a = a.substring(0, r)),
        (r = a.indexOf(" ")) != -1 && (a = a.substring(0, r)),
        (r = a.indexOf(")")) != -1 && (a = a.substring(0, r)),
        d = parseInt("" + a, 10),
        isNaN(d) ? (a = "" + parseFloat(navigator.appVersion),
        d = parseInt(navigator.appVersion, 10)) : a = "" + parseFloat(a);
        ...
        var g = t;
        switch (/Windows/.test(l) && (g = /Windows (.*)/.exec(l)[1],
        l = "Windows"),
        l) {
        case "Mac OS X":
            g = /Mac OS X (10[\.\_\d]+)/.exec(s)[1];
            break;
        case "Android":
            g = /Android ([\.\_\d]+)/.exec(s)[1];
            break;
        case "iOS":
            g = /OS (\d+)_(\d+)_?(\d+)?/.exec(o),
            g = g[1] + "." + g[2] + "." + (0 | g[3])
        }
        return {
            ...
            gpu: function() {
                ...
                if (n) {
                    ...
                    if (r)
                        return n.getParameter(r.UNMASKED_RENDERER_WEBGL)
                }
                return t
            }(),
            ...
            hasWebGL: function() {
                ...
                return n ? 2 : (n = e.getContext("experimental-webgl2"),
                n ? 2 : (n = e.getContext("webgl"),
                n || (n = e.getContext("experimental-webgl")) ? 1 : 0))
            }(),
            ...
            hasFullscreen: function() {
                var e = document.createElement("canvas");
                return (e.requestFullScreen || e.mozRequestFullScreen || e.msRequestFullscreen || e.webkitRequestFullScreen) && (i.indexOf("Safari") == -1 || a >= 10.1) ? 1 : 0
            }(),
            ...
            hasWasmThreads: function() {
                ...
                var e = new WebAssembly.Memory({
                  ...
                  , n = e.buffer instanceof SharedArrayBuffer;
                return delete e,
                n
            }()
        }
    ...
    new Promise(function(e, n) {
        ...
        d()) : n("Your browser does not support WebAssembly.") : n("Your browser does not support WebGL.")
    }
    )
}
